...
в коде можно поменять название папки (первая строчка)
и название + расширение файл (во второй строчке)
...
меню создано при помощи оффициального обучнения MonoGame(если это именно тот сайт конечно):
